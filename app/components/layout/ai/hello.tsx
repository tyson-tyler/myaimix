...
export default function LikeButton() {
  ...
  return (
    <svg
      onClick={handleClick}
      className={`w-10 h-10 cursor-pointer transform transition-transform duration-300 hover:scale-125 
        ${isClicked ? "animate-popper" : ""}`}
      viewBox="0 0 512 512"
    ...
    >
      <defs>
        <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop
            offset="100%"
            style={{ stopColor: "#e52e71", stopOpacity: 1 }}
          />
        </linearGradient>
      </defs>
      ...
      <path
        d="M219,119.55C168.46,92.08,101.46,80.69,98.63,80.22A16,16,0,0,0,81,90.55a16.47,16.47,0,0,0,3.79,16.84c31.84,33.78,32.86,68.79,28.65,104.63a4.45,4.45,0,0,0,2.5,4.54h0a4.44,4.44,0,0,0,5.08-.9c16.39-16.51,36.37-31.52,60.4-45.39l4.48-2.6C208,154.8,216.23,150,236,140.41l2.69-1.3a4,4,0,0,0,.64-6.83A178.59,178.59,0,0,0,219,119.55Z"
        fill="url(#grad1)"
      ></path>

      <path
        d="M234.26,91.45c3.44,1.87,7.09,4,10.9,6.29a189.31,189.31,0,0,1,29.57,22.39,4,4,0,0,0,4.28.76,672,672,0,0,1,69.65-25q7-2.07,14.08-4a4,4,0,0,0,2.53-5.62C357,69.44,350.6,57.37,350.12,56.48A16,16,0,0,0,336,48c-1.91,0-33.28.36-76.87,21.3a279,279,0,0,0-26.39,14.51,4,4,0,0,0,.22,6.94Z"
        fill="url(#grad1)"
      ></path>
